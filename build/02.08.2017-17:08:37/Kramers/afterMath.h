...
void countRight(vector<double>& vec,vector<double>& vec1, vector<double>& vec2, vector<double>& vec3, const vector< vector<double> >& data, const double& border,const double& Kborder,const bool& Kramers,const int& k);
